...
$objFetchData->GetSocietyDetails($objFetchData->GetSocietyID($_REQUEST["UnitID"]));
$objFetchData->GetMemberDetailsRec($_REQUEST["UnitID"]);   // confusion 
...
$objFetchData->GetMemberDetailsRec($_REQUEST["UnitID"],$BillDate);
...
{
	console.log("code :" +'<?php echo $objFetchData->objSocietyDetails->sSocietyCode; ?>');
	var gencnt = 1;
...
<body>
    ...
    <center>
        ...
        <?php 
			...
			{?>
        		<INPUT TYPE="button" id="Edit" onclick="window.location.href='Maintenance_billrec.php?UnitID='+ <?php echo $_REQUEST['UnitID'] ?> + '&PeriodID='+ <?php echo $_REQUEST['PeriodID']?> +'&BT='+ <?php echo $_REQUEST['BT']?>+ '&edt'" name="Edit" value="Edit" width="300" style="width:60px;height:30px; font-size:20px" />
		...
		{?>
			<script>window.location.href='Maintenance_billrec.php?UnitID='+ <?php echo $_REQUEST["UnitID"]?> + '&PeriodID='+ <?php echo $_REQUEST["PeriodID"]?>+'&BT='+<?php echo $IsSupplementaryBill;?></script>
		<?php 
		}
	}?>
   </div>
        ...
        <div id="bill_charges">
        	<table  style="width:100%;font-size:14px;" id="mainTable">
                ...
                <?php
					...
					{?>
                		<tr>
                        	<td style='border:1px solid black;border-left:none;text-align:center;font-size:<?php echo $BillFont?>px;'></td>
                            <td colspan=3 style='border:1px solid black;text-align-left;font-size:<?php echo $BillFont?>px;'></td>
                            <td align=right style='border:1px solid black;border-right:none;text-align:right;width:15%;font-size:14px;'> <input type="button"  name="ADD" id="ADD" value="ADD" onclick="AddNewRow();"/></td>
                        </tr>
           		<?php }?>
           </table>
           <?php
