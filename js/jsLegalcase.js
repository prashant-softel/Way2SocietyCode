...
{ //alert("hi");	
	...
	if(iden[0]=="delete")
	{
		...
		if(conf==1)
		{			
			remoteCall("ajax/ajaxlegalcase.php","&method="+iden[0]+"&requestId="+iden[1],"loadchanges");
		}
	}
	else
	{
...
{	
	...
	{		
		...
		window.location.href ="legalcase.php";
	}
}
...
function del_photo(img,qr)
	{
		...
		if(qr!="")
		{
			...
			{	
				...
				remoteCall("ajax/ajaxlegalcase.php","form=servicerequest&method=del_photo&qr="+qr+"&img="+img,"deletedImage");	
			}
		}	
	}
