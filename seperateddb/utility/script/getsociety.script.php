<?php
	...
	if(isset($_REQUEST['clientId']))
	{
		...
		try
		{
			...
			//echo "SELECT s.society_name,s.dbname,s.Last_use_society_timestamp,c.client_name FROM `society` as s join client as c on c.id=s.client_id where s.client_id ='".$_REQUEST['clientId']."'";
