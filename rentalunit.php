...
include_once("classes/rentalunit.class.php");
include_once("classes/initialize.class.php");
include_once("classes/utility.class.php");
$obj_unit = new rentalunit($m_dbConn, $m_dbConnRoot,$landLordDB);
	  ...
	  $('#insert').click(function(){
		   ...
		   var isChecked = $('#Blocked').is(':checked');
			if(r.length<1 && isChecked){
				...
				$('#unitForm').attr('action',"process/rentalunit.process.php");
			}
	  });
	   function a(){
		 var isChecked = $('#Blocked').is(':checked');
...
<center>
<form name="unitForm" id="unitForm" method="post" action="process/rentalunit.process.php" <?php echo $val;?> onSubmit=" return validateOwnershipTransfer();">
	...
	?>
       <table align='center' style=" width:100%;">
		...
		<?php if($_SESSION['res_flag'] == 1){ ?>
			<tr><td valign="middle"><?php echo $star;?></td>
		...
		<td>&nbsp;&nbsp; : &nbsp;&nbsp;</td>
		<td>
			<select name="wing_id" id="wing_id" style="width:142px;" onChange="clear_unit(this.value);" value="<?php echo $_REQUEST['wing_id'];?>">
				<?php echo $combo_wing = $obj_unit->getTenantWing($_SESSION['unit_id']);?>
			</select>
		</td></tr>
		</td>
         <td><tr></tr></td>
		...
		<tr align="left">
            ...
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="unit_no" id="unit_no" value="<?php echo $_REQUEST['unit_no'];?>"/></td>
       ...
       <table width="50%" style="font-size:12px; float:left;" id="PrintableTable">
        ...
        <tr align="left" class="UnitFields">
            ...
            <td>&nbsp; : &nbsp;</td>
			<td>
			<select name = "property_type" id="property_type" value="<?php echo $_REQUEST['property_type'];?>">
			<?php echo $property = $obj_unit->combobox("select id,name from property_usage where status='Y' and society_id='".$_SESSION['society_id']."'",$wing_id); ?>
			</select>	
			<!-- <input type="text" name="property_type" id="property_type" value="<?php echo $_REQUEST['property_type'];?>"/></td> -->
		</tr>
        ...
        <tr align="left" class="UnitFields">
            ...
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="flat_configuration" id="flat_configuration" value="<?php echo $_REQUEST['flat_configuration'];?>"/></td>
		</tr>
        ...
        <tr align="left" class="UnitFields">
			...
			<td>Location</td>
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="location" id="location" value="<?php echo $_REQUEST['location'];?>"/></td>
		</tr>
        ...
        <tr align="left" class="UnitFields">
			...
			<td>Plot No</td>
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="plot_no" id="plot_no" value="<?php echo $_REQUEST['plot_no'];?>"/></td>
		</tr>
        ...
        <tr align="left" class="UnitFields">
			...
			<td>Makani No</td>
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="makani_no" id="makani_no" value="<?php echo $_REQUEST['makani_no'];?>"/></td>
		</tr>
        ...
        <tr align="left" class="UnitFields">
			...
			<td>Premises No</td>
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="premises_no" id="premises_no" value="<?php echo $_REQUEST['premises_no'];?>"/></td>
		</tr>
        ...
        <tr align="left" class="UnitFields">
			...
			<td>Property No</td>
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="property_no" id="property_no" value="<?php echo $_REQUEST['property_no'];?>"/></td>
		</tr>
        <!--
        <tr align="left">
        	<td valign="middle"><?php //echo $star;?></td>
        ...
        <tr align="left" class="UnitFields">
			...
			<td>Previous Year</td>
            <td>&nbsp; : &nbsp;</td>
			<td><select name="Year" id="Year" value='<?php echo $_POST['Year']; ?>' onChange="jsGetperiods(this.value, 0);"> <!--disabled="disabled"-->
        ...
        <tr align="left" class="UnitFields">
            ...
            <td>&nbsp; : &nbsp;</td>
			<td><select name="Period" id="Period" value='<?php echo $_POST['Period']; ?>'> <!--disabled="disabled"-->
        ...
        <tr align="left" class="UnitFields">
            ...
            <td>&nbsp; : &nbsp;</td>
			<td><input type="checkbox" value="1" id="GSTNoExp" name="GSTNoExp"></td>
            <td></td>
		</tr>
        <?php }?>
		<tr align="left" class="UnitFields">
		...
		<tr align="left" class="UnitFields">
            ...
            <td>&nbsp; : &nbsp;</td>
			<td><input   type="text"   <?php  echo $bIsCurrentYearAndCreationYrMatch == false ?  'readonly  style="background-color:#CCC;"' : ''; ?>  name="bill_subtotal" id="bill_subtotal"  value="<?php echo $_REQUEST['bill_subtotal'];?>" /></td>
			<td><input   type="text"   <?php  echo $bIsCurrentYearAndCreationYrMatch == false ?  'readonly  style="background-color:#CCC;"' : ''; ?>  name="supp_bill_subtotal" id="supp_bill_subtotal"  value="<?php echo $_REQUEST['supp_bill_subtotal'];?>" /></td>
		</tr>
        ...
        <tr align="left" class="UnitFields">
            ...
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" <?php  echo $bIsCurrentYearAndCreationYrMatch == false ?   'readonly  style="background-color:#CCC;"' : ''; ?>  name="bill_interest" id="bill_interest" value="<?php echo $_REQUEST['bill_tax'];?>"/></td>
			<td><input type="text" <?php  echo $bIsCurrentYearAndCreationYrMatch == false ?   'readonly  style="background-color:#CCC;"' : ''; ?>  name="supp_bill_interest" id="supp_bill_interest" value="<?php echo $_REQUEST['supp_bill_tax'];?>"/></td>
		</tr>
        ...
        <tr align="left" class="UnitFields">
            ...
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" <?php  echo $bIsCurrentYearAndCreationYrMatch == false ?  'readonly  style="background-color:#CCC;"': ''; ?>  name="principle_balance" id="principle_balance" value="<?php echo $_REQUEST['principle_balance'];?>" /></td>
			<td><input type="text" <?php  echo $bIsCurrentYearAndCreationYrMatch == false ?  'readonly  style="background-color:#CCC;"': ''; ?>  name="supp_principle_balance" id="supp_principle_balance" value="<?php echo $_REQUEST['supp_principle_balance'];?>"/></td>
		</tr>
        ...
        <tr align="left" class="UnitFields">
            ...
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" <?php  echo $bIsCurrentYearAndCreationYrMatch == false ?  'readonly  style="background-color:#CCC;"' : ''; ?> name="interest_balance" id="interest_balance" value="<?php echo $_REQUEST['interest_balance'];?>"/></td>
			<td><input type="text" <?php  echo $bIsCurrentYearAndCreationYrMatch == false ?  'readonly  style="background-color:#CCC;"' : ''; ?> name="supp_interest_balance" id="supp_interest_balance" value="<?php echo $_REQUEST['supp_interest_balance'];?>"/></td>
		</tr>
