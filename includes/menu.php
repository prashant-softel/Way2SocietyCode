                    ...
                    <div class="left" style="width:100%;text-align:center">
                        <div class="right" style="width:100%;text-align:center">
                            ...
                            <?php if($_SESSION['res_flag'] == 1 || $_SESSION['rental_flag'] == 1){ ?>
                                ...
                                <li><a href="ReportMain.php" id="<?php echo $cls2;?>" rel="dropmenu2"><em><b style="height:50px;text-align:center;margin-top:5px">REPORTS</b></em></a></li>                  
...
<a href="unit_search.php?imp"  style="font-size:12px;text-align:center;height:30px;margin-top:10px">View Units</a>
...
<div id="dropmenu2" class="dropmenudiv" style="width:170px;">
    <!--<a href="reports.php?&sid=<?php //secho $_SESSION['society_id']; ?> " style="font-size:12px;text-align:center;height:30px;margin-top:10px">Member Dues</a>
    <a href="dues_advance_frm_member_report.php?&sid=<?php //echo $_SESSION['society_id']; ?> " style="font-size:12px;text-align:center;height:30px;margin-top:10px">Dues-Advance From Members</a>
    <a href="paymentregi_report.php" style="font-size:12px;text-align:center;height:30px;margin-top:10px">Payment Register</a>-->
